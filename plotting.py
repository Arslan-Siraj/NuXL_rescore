...
def plot_FDR_plot(idXML_id, idXML_extra):
    ...
    plt.title("XL FDR PSM comparison")
    ...
    plt.legend()
    plt.savefig(outfile_path[0] + "_XL_FDR_PSM_0.01.pdf")
    #plt.show()
    ...
    ax.set_ylim(0, len_3000)
    plt.legend()
    plt.savefig(outfile_path[0] + "_XL_FDR_PSM_0.02.pdf")
    #plt.show()
    ...
    #ax.set_xscale('log', base=10)
    plt.legend()
    plt.savefig(outfile_path[0] + "_XL_FDR_PSM_1.0.pdf")
    #plt.show()
